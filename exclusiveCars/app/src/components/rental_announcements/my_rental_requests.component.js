...
export default class MyRentalRequests extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        document.title = "Cereri de închiriere";
        this.setState({loading: true});

        axios.get(`http://localhost:8090/api/rentCars/myRentalRequests`, {
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
                Authorization: authHeader().Authorization
    ...
    render() {
        ...
        if(rentals !== [] && rentals !== "Nu a fost efectuată nicio programare momentan!") {
        ...
        return (
            <>
                ...
                <div style={{height: "50px"}}>
                    <h1 style={{float: "left"}}>Cereri de închiriere</h1>
                </div>
